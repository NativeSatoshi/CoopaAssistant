...
async function handleToolCall(functionCall, context) {
    ...
    switch (name) {
        ...
        case 'find_memory':
            ...
            toolResult = { ...memoryResult }; // result for model
            delete toolResult.data; // remove large data from what model sees
            if (memoryResult.found) {
                newDisplayData = memoryResult.data; // data for frontend
